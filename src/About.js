    ...
    return (
        <div className="text-blurbs">
            <h1>Who is Russell Monteith?</h1>
                ...
                before graduating. The CPA test is a grueling test with an average pass rate of 50%. He has experience working in many
                different areas of tax from small businesses to large partnerships, from trusts to gift taxes, 
                from non-profits to corporations, and from small individuals to wealthy individuals. Russell's wide array of experience
                sets him apart from others in the business.
                </p>
                <br/>
                <br/>
            <h2>What else can Russell do?</h2> 
                <p className="text-blurbs-content">
                Russell is also a front end web developer. He has been learning how to build web applications since
                2020. He built this entire website all by himself. Can Russell help your accounting practice build an internal web application? 
